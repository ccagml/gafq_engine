...
game: game.cpp game_config.cpp game_config.h script_engine.h script_engine_msg_base.h
	...
	g++ -Wall -g -std=c++11 game.cpp game_config.cpp script_engine.cpp -o game -I /root/gafq_engine -L/root/gafq_engine/3rd/mysqlcapi/lib -I/root/gafq_engine/3rd/mysqlcapi/include  -I /root/gafq_engine/3rd/gafq/include -L/root/gafq_engine/3rd/gafq/lib -lgafq -lmysqlclient -lboost_program_options -lboost_system -lboost_filesystem  -lpthread -lboost_thread
