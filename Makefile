...
chat_client: chat_client.cpp socket_msg.h
	g++ -Wall -g -std=c++11 chat_client.cpp -o chat_client -I /root/gafq_engine -lboost_program_options -lboost_system -lboost_filesystem -lpthread -lboost_thread
...
clean:
	 rm game game_config.o game_config test_db_mysql_c test_game_eng script_engine chat_client