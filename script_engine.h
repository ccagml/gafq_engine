...
public:
    ...
    void ExecGafq(std::string lua_content = std::string(), int fd = -1, int func = -1, std::shared_ptr<ScriptEngineMsgBase> msg = nullptr, int cookie = -1, int ret = -1, std::string errmsg = std::string());
